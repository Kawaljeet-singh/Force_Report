                                ...
                                <table class="dashboard-table" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
										...
										echo	'<tr>
												...
												<td><a href="'.base_url('view_user/'.$dash->user_key).'" class="approve-btn">View</a>
												<a href="'.base_url('edit_user/'.$dash->user_key).'" class="edit-btn">Edit</a>
												<a href="'.base_url('delete_user/'.$dash->user_key).'" class="decline-btn">Decline</a></td>
											</tr>';
										 }?>
                                    </tbody>
                                </table>
